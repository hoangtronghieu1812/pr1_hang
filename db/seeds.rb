...
Cosmetic.create!(name:  "Kẻ Mắt Isehan Kiss",
             price: 160000,
             quantity_in_store: "6",
             image: File.open("app/assets/images/kemat.jpg"),
             category_id: "1",
             trademark_id: "2",
...
Cosmetic.create!(name:  "Phấn Nền 4 Trong 1 L’Oreal",
             ...
             quantity_in_store: "10",
              image: File.open("app/assets/images/phannen1.png"),
             category_id: "1",
             trademark_id: "1",
...
Cosmetic.create!(name: "Sữa Rửa Mặt DHC",
             price: 190000,
             quantity_in_store: "3",
             image: File.open("app/assets/images/srm1.png"),
             category_id: "2",
             trademark_id: "4",
...
Cosmetic.create!(name: "Dầu Gội L’oreal Paris",
             price: 190000,
             quantity_in_store: "4",
             image: File.open("app/assets/images/dg1.png"),
             category_id: "4",
             trademark_id: "5",
...
Cosmetic.create!(name: "Dưỡng Thể Tẩy Tế Bào Chết Paula’s Choice ",
             price: 190000,
             quantity_in_store: "5",
             image: File.open("app/assets/images/body1.png"),
             category_id: "3",
             trademark_id: "4",
...
Cosmetic.create!(name: "Viên uống chống nắng nội sinh Murad",
             price: 190000,
             quantity_in_store: "6",
             image: File.open("app/assets/images/formen1.jpg"),
             category_id: "5",
             trademark_id: "3",
...
Cosmetic.create!(name: "Set Son Kem YSL Mini 3 Cây",
             price: 360000,
             quantity_in_store: "10",
             image: File.open("app/assets/images/son2.jpg"),
             category_id: "1",
             trademark_id: "5",
...
Cosmetic.create!(name: "Son Iris",
             price: 200000,
             quantity_in_store: "10",
             image: File.open("app/assets/images/son1.jpg"),
             category_id: "1",
             trademark_id: "3",
             description: "Chất son kem nhẹ, mềm mượt. Độ lên màu cực chuẩn và bám màu tốt trong nhiều giờ. Làm căng đầy những rãnh môi khô nứt.")
Cosmetic.create!(name: "Sữa Rửa Mặt Biore Face Wash",
             price: 200000,
             quantity_in_store: "10",
             image: File.open("app/assets/images/srm2.jpg"),
             category_id: "2",
             trademark_id: "1",
...
Cosmetic.create!(name: "Kem Nhuộm Tóc L’Oreal Paris",
             price: 400000,
             quantity_in_store: "10",
             image: File.open("app/assets/images/nhuomtoc1.png"),
             category_id: "4",
             trademark_id: "5",
...
11.upto(30) do |n|
  ...
  Cosmetic.create!(name: title,
             ...
             image: File.open("app/assets/images/cosmetic#{n}.jpg"),
